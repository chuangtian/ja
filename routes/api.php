...
Route::post('wsend/erc20', 'ApiController@wsend');
...
Route::get('sendErc20', 'JobController@sendErc20');
Route::get('tsendeth', 'JobController@tsendeth');
Route::post('tsenduset', 'JobController@tsenduset');
...
Route::get('aatest', 'UpdateController@aatest');
